...
import pytest
# testing for login the session is a term used to describe the state of a user's interaction with an application. 
# A session begins when a user logs in to the application and ends when the user logs out or closes the application.
