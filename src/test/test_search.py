...
# Agent for actor(is ny given user) search
class AtpAgent:
    def __init__(self, client):
        self.client = client
# Search for actors base on a user handle returns a list of actors
...
# Search for actors base on a user handle return that actor
